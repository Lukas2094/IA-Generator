    ...
    const renderMessageContent = (text: string) => {
        ...
        return parts.map((part, i) =>
            i % 2 === 1 ? (
                <pre
                    key={i}
                    className="bg-gray-900 text-green-300 text-xs rounded-md p-3 overflow-auto whitespace-pre-wrap mb-2"
                >
                    <code>{part.trim()}</code>
                </pre>
            ) : (
            ...
            <div className="w-full max-w-2xl bg-white rounded-lg shadow-md p-6 flex flex-col space-y-4">
                ...
                <div className="flex space-x-2">
                    ...
                    <button
                        ...
                        className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                        {loading ? (
                            <>
